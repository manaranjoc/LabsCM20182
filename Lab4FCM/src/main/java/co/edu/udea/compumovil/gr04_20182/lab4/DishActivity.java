...
public class DishActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                PermissionListener permissionlistener = new PermissionListener() {
                    ...
                    public void onPermissionGranted() {
                        TedBottomPicker tedBottomPicker = new TedBottomPicker.Builder(DishActivity.this)
                                .setOnImageSelectedListener(new TedBottomPicker.OnImageSelectedListener() {
                                    ...
                                    public void onImageSelected(Uri uri) {
                                        ...
                                        dishPojo.setImageUri(uri.toString());
                                    }
                                })
                                .create();
                    ...
                    public void onPermissionDenied(ArrayList<String> deniedPermissions) {
                        Toast.makeText(DishActivity.this, "Permission Denied\n" + deniedPermissions.toString(), Toast.LENGTH_SHORT).show();
                    }


                };
                TedPermission.with(DishActivity.this)
        ...
        updatePreviewMeal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mealScheduleUpdate();
                typeOfMealUpdate();
                TextView prepTime = findViewById(R.id.preparation_time);
                dishPojo.setTime(prepTime.getText().toString());
                dishPojo.setFavorite(false);
                createDishDatabase();
                editor.commit();
            }
        });
    ...
    private void updateTextFields(){
        ...
        dishPojo.setName(nameMeal.getText().toString());
    ...
    private void mealScheduleUpdate(){
        ...
        if(!schedule.isEmpty()){
            ...
            dishPojo.setSchedule(mealSchedule.getText().toString());
    ...
    private void typeOfMealUpdate(){
        ...
        if(entrance){
            dishPojo.setType("Entrance");
            typeOfMeal.setText(R.string.entrance);
        }else if (mainDish){
            dishPojo.setType("Main Dish");
